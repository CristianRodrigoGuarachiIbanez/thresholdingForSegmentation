...
<p>The current algorithmus was designed to segment images in real-time inside a 3D-Icub-Simulator. It detects the arm of the iCub-robot as well as the object
